                        ...
                        float *restrict dst, int dst_stride)
{
    ...
    // ========== OUTPUT ROW 0 ==========
    // output[0] = 0.25*input[-1] + 0.5*input[0] + 0.25*input[1]
    ...
    // Store output row 0
    _mm256_storeu_ps(dst+0*dst_stride+0,  ymm0);
    _mm256_storeu_ps(dst+0*dst_stride+8,  ymm1);
    _mm256_storeu_ps(dst+0*dst_stride+16, ymm2);
    _mm256_storeu_ps(dst+0*dst_stride+24, ymm3);
    _mm256_storeu_ps(dst+0*dst_stride+32, ymm4);
    _mm256_storeu_ps(dst+0*dst_stride+40, ymm5);
    _mm256_storeu_ps(dst+0*dst_stride+48, ymm6);
    _mm256_storeu_ps(dst+0*dst_stride+56, ymm7);
    _mm256_storeu_ps(dst+0*dst_stride+64, ymm8);
    _mm256_storeu_ps(dst+0*dst_stride+72, ymm9);

    // ========== OUTPUT ROW 1 ==========
    // output[1] = 0.25*input[0] + 0.5*input[1] + 0.25*input[2]
    ymm0=_mm256_setzero_ps(); ymm1=_mm256_setzero_ps(); ymm2=_mm256_setzero_ps(); ymm3=_mm256_setzero_ps(); ymm4=_mm256_setzero_ps();
    ymm5=_mm256_setzero_ps(); ymm6=_mm256_setzero_ps(); ymm7=_mm256_setzero_ps(); ymm8=_mm256_setzero_ps(); ymm9=_mm256_setzero_ps();

    // Load row 0 (0.25 coefficient)
    ...
    // Store output row 1
    _mm256_storeu_ps(dst+1*dst_stride+0,  ymm0);
    _mm256_storeu_ps(dst+1*dst_stride+8,  ymm1);
    _mm256_storeu_ps(dst+1*dst_stride+16, ymm2);
    _mm256_storeu_ps(dst+1*dst_stride+24, ymm3);
    _mm256_storeu_ps(dst+1*dst_stride+32, ymm4);
    _mm256_storeu_ps(dst+1*dst_stride+40, ymm5);
    _mm256_storeu_ps(dst+1*dst_stride+48, ymm6);
    _mm256_storeu_ps(dst+1*dst_stride+56, ymm7);
    _mm256_storeu_ps(dst+1*dst_stride+64, ymm8);
    _mm256_storeu_ps(dst+1*dst_stride+72, ymm9);

    // ========== OUTPUT ROW 2 ==========
    // output[2] = 0.25*input[1] + 0.5*input[2] + 0.25*input[3]
    ymm0=_mm256_setzero_ps(); ymm1=_mm256_setzero_ps(); ymm2=_mm256_setzero_ps(); ymm3=_mm256_setzero_ps(); ymm4=_mm256_setzero_ps();
    ymm5=_mm256_setzero_ps(); ymm6=_mm256_setzero_ps(); ymm7=_mm256_setzero_ps(); ymm8=_mm256_setzero_ps(); ymm9=_mm256_setzero_ps();
    ...
    // Store output row 2
    _mm256_storeu_ps(dst+2*dst_stride+0,  ymm0);
    _mm256_storeu_ps(dst+2*dst_stride+8,  ymm1);
    _mm256_storeu_ps(dst+2*dst_stride+16, ymm2);
    _mm256_storeu_ps(dst+2*dst_stride+24, ymm3);
    _mm256_storeu_ps(dst+2*dst_stride+32, ymm4);
    _mm256_storeu_ps(dst+2*dst_stride+40, ymm5);
    _mm256_storeu_ps(dst+2*dst_stride+48, ymm6);
    _mm256_storeu_ps(dst+2*dst_stride+56, ymm7);
    _mm256_storeu_ps(dst+2*dst_stride+64, ymm8);
    _mm256_storeu_ps(dst+2*dst_stride+72, ymm9);

    // ========== OUTPUT ROW 3 ==========
    // output[3] = 0.25*input[2] + 0.5*input[3] + 0.25*input[4]
    ymm0=_mm256_setzero_ps(); ymm1=_mm256_setzero_ps(); ymm2=_mm256_setzero_ps(); ymm3=_mm256_setzero_ps(); ymm4=_mm256_setzero_ps();
    ymm5=_mm256_setzero_ps(); ymm6=_mm256_setzero_ps(); ymm7=_mm256_setzero_ps(); ymm8=_mm256_setzero_ps(); ymm9=_mm256_setzero_ps();
    ...
    // Store output row 3
    _mm256_storeu_ps(dst+3*dst_stride+0,  ymm0);
    _mm256_storeu_ps(dst+3*dst_stride+8,  ymm1);
    _mm256_storeu_ps(dst+3*dst_stride+16, ymm2);
    _mm256_storeu_ps(dst+3*dst_stride+24, ymm3);
    _mm256_storeu_ps(dst+3*dst_stride+32, ymm4);
    _mm256_storeu_ps(dst+3*dst_stride+40, ymm5);
    _mm256_storeu_ps(dst+3*dst_stride+48, ymm6);
    _mm256_storeu_ps(dst+3*dst_stride+56, ymm7);
    _mm256_storeu_ps(dst+3*dst_stride+64, ymm8);
    _mm256_storeu_ps(dst+3*dst_stride+72, ymm9);
